...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/repoze.who-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8034&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/repoze.who-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `repoze.who` can be installed with:

```
conda install repoze.who
```

It is possible to list all of the versions of `repoze.who` available on your platform with:
